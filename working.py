...
# SIFT matching
MIN_MATCH_COUNT = 15        # Minimum good feature matches to consider
MIN_INLIERS = 15            # Minimum geometric inliers for TRUE
RATIO_TEST = 0.65           # Lowe's ratio test (lower = stricter)
