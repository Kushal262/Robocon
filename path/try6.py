...
# ────────── CONFIG ──────────
IMG_W, IMG_H = 600, 1210           # Figma frame dimensions
GRID = 20                          # Fine grid for precise path selection
LINEAR_SPEED = 70
ANGULAR_SPEED = 2.8
MAX_KFS = 4
...
# ────────── INIT ──────────
pygame.init()
screen = pygame.display.set_mode((1280, 1000), pygame.RESIZABLE)
...
def draw_path(rect):
    ...
    s.fill((255, 210, 0, 140))  # yellow path highlight
    for r, c in path_cells:
        screen.blit(s, (rect.x + c * GRID, rect.y + r * GRID))

def draw_kfs(rect):
    s = pygame.Surface((GRID, GRID), pygame.SRCALPHA)
    s.fill((0, 240, 240, 160))  # cyan KFS highlight
...
def draw_arena(rect):
    ...
    # Top zone
    dr(COLOR_ZONE1,       2.5,   5, 595, 192)     # zone-1-area
    ...
    # Forest blocks (12 blocks)
    forest = [
        (362.5, 325, COLOR_FOREST_DARK),   # 1
        (242.5, 325, COLOR_FOREST_DARKER), # 2
        (122.5, 325, COLOR_FOREST_DARK),   # 3
        (362.5, 445, COLOR_FOREST_DARKER), # 4
        (242.5, 445, COLOR_FOREST_DARK),   # 5
        (122.5, 445, COLOR_FOREST_LIGHT),  # 6
        (362.5, 565, COLOR_FOREST_DARK),   # 7
        (242.5, 565, COLOR_FOREST_LIGHT),  # 8
        (122.5, 565, COLOR_FOREST_DARK),   # 9
        (362.5, 685, COLOR_FOREST_DARKER), # 10
        (242.5, 685, COLOR_FOREST_DARK),   # 11
        (122.5, 685, COLOR_FOREST_DARKER), # 12
    ]
